...
public class Exercises {
	...
	public String makeAbba(String a, String b) {
		String jointFirst =a+b;
		String jointSecond = b+a;
		return  jointFirst+jointSecond;
	}
	...
	public String extraEnd(String str) {
		return str.substring(str.length()-2)+str.substring(str.length()-2,str.length())+str.substring(str.length()-2,str.length());
	}
	...
	public String stringX(String str) {
		if(str.length()==1) return str;
			...
			Character startChart = str.charAt(0);
			Character endChart = str.charAt(str.length()-1);
			str = str.substring(1,(str.length()-1)).replace("x","");
			return startChart+str+endChart;
		}
	}
	...
	public String altPairs(String str) {
		...
		for(int i=0;i<str.length();i+=4){
			...
			newString = newString + str.substring(i,end);
		}
		return newString;
	}
